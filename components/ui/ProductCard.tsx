...
export default function ProductCard({
  ...
  return (
    <div className="bg-white rounded-2xl border border-neutral-200 p-8 hover:shadow-xl transition-all">
        ...
        {specs.autonomy && (
          <div className="flex items-start">
            ...
            <span className="text-sm text-neutral-700">
              <strong>Autonomía:</strong> {specs.autonomy}
            </span>
          </div>
        )}
        {specs.altitude && (
          <div className="flex items-start">
            ...
            <span className="text-sm text-neutral-700">
              <strong>Altitud:</strong> {specs.altitude}
            </span>
          </div>
        )}
        {specs.payload && (
          <div className="flex items-start">
            ...
            <span className="text-sm text-neutral-700">
              <strong>Payload:</strong> {specs.payload}
            </span>
          </div>
        )}
        {specs.sensors && specs.sensors.length > 0 && (
          <div className="flex items-start">
            ...
            <div className="text-sm text-neutral-700">
              <strong>Sensores:</strong> {specs.sensors.join(', ')}
            </div>
          </div>
        )}
      </div>
